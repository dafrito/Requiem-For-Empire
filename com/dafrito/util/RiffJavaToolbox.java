...
import com.dafrito.gui.RiffInterface_MouseListener;
...
public class RiffJavaToolbox {
    ...
    public static String getColorName(Color color) {
        // W3C CSS standard colors: aqua, black, blue, fuchsia, gray, green,
    ...
    public static Color getColor(String colorString) {
        ...
        // lime, maroon, navy, olive, purple, red, silver, teal, white, and
        // yellow
        String workingColorString = colorString;
        if(colorString.charAt(0) != '#') {
            ...
            workingColorString = "#" + colorString;
        }
        if(workingColorString.length() == 4) {
            workingColorString = "#"
                + workingColorString.charAt(1)
                + workingColorString.charAt(1)
                + workingColorString.charAt(2)
                + workingColorString.charAt(2)
                + workingColorString.charAt(3)
                + workingColorString.charAt(3);
        }
        try {
            return Color.decode(workingColorString);

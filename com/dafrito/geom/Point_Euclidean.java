...
public class Point_Euclidean extends Point implements ScriptConvertible{
	...
	public void addX(double x){this.m_x+=x;}
	public void addY(double y){this.m_y+=y;}
	public void addZ(double z){this.m_z+=z;}

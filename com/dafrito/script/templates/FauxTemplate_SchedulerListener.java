...
public class FauxTemplate_SchedulerListener extends FauxTemplate {
    ...
    public ScriptTemplate instantiateTemplate() {
        return new FauxTemplate_SchedulerListener(getEnvironment(), getType());
    }
    ...
    public void initialize() throws Exception_Nodeable {
        assert LegacyDebugger.open("Faux Template Initializations", "Initializing scheduler listener faux template");
        disableFullCreation();
    ...
    public ScriptValue_Abstract execute(Referenced ref, String name, List<ScriptValue_Abstract> params,
        ...
        assert LegacyDebugger.open("Faux Template Executions", "Executing scheduler listener faux template function ("
    ...
    public boolean nodificate() {
        assert LegacyDebugger.open("Scheduler listener faux template");

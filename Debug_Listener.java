...
class TreePathStruct{
	...
	public TreePath getPath(){return m_path;}
	public boolean isExpanding(){return m_isExpanding;}
}
public class Debug_Listener extends JPanel implements ActionListener,ComponentListener{
	...
	public Debug_Hotspots getHotspotPanel(){return m_hotspotPanel;}
	public Debug_Tree getTreePanel(){return m_treePanel;}
	public boolean isSynchronizing(){return m_isSynchronized.isSelected();}
	public boolean isFiltering(){return m_defaultFilter.isSelected();}
	public boolean isCapturing(){return m_isCapturing.isSelected();}
	public boolean isUnfiltered(){return m_source==null;}
	public Debug_Listener getSource(){return m_source;}
	// Setters
	...
	public void setFiltering(boolean isFiltering){
		...
		if(m_defaultFilter.isSelected()){
			if(m_debugger.getFilteringOutput()!=null){m_debugger.getFilteringOutput().setFiltering(false);}
	...
	public void setSource(Debug_Listener source){m_source=source;}
	// Command functions
	...
	public void sendToFilter(){
		...
		if(obj!=null){m_debugger.getFilteringOutput().getTreePanel().getFilter().addFilter(obj);}
	}
	public void jump(){

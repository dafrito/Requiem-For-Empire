...
public class ScriptFunction implements Nodeable,ScriptFunction_Abstract{
	public static String getDisplayableFunctionName(String name){
		if(name==null||name.equals("")){return "constructor";}
		return name;
	}
	...
	public ScriptValueType getReturnType(){return m_type;}
	public ScriptValue_Abstract getReturnValue(){return m_returnValue;}
	public void setReturnValue(Referenced ref,ScriptValue_Abstract value) throws Exception_Nodeable{
		if(value==null&&getReturnType().equals(ScriptKeywordType.VOID)){return;}
	...
	public List<ScriptValue_Abstract>getParameters(){return m_params;}
	...
	public void addExpression(ScriptExecutable exp)throws Exception_Nodeable{assert exp!=null;m_expressions.add(exp);}
	public void addExpressions(Collection<ScriptExecutable>list)throws Exception_Nodeable{
		for(ScriptExecutable exec:list){addExpression(exec);}
	}
	public boolean areParametersConvertible(List<ScriptValue_Abstract>list){return areParametersConvertible(getParameters(),list);}
	...
	public boolean areParametersEqual(List<ScriptValue_Abstract>list){return areParametersEqual(getParameters(),list);}

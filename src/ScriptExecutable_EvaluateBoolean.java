public class ScriptExecutable_EvaluateBoolean extends ScriptElement implements ScriptExecutable, ScriptValue_Abstract {
	...
	public ScriptValue_Abstract execute() throws Exception_Nodeable {
		...
		switch (m_comparison) {
		case NONEQUIVALENCY:
			returning = new ScriptValue_Boolean(getEnvironment(), !lhs.valuesEqual(this, rhs));
			break;
		case LESS:
			returning = new ScriptValue_Boolean(getEnvironment(), (lhs.valuesCompare(this, rhs) < 0));
			break;
		case LESSEQUALS:
			returning = new ScriptValue_Boolean(getEnvironment(), (lhs.valuesCompare(this, rhs) <= 0));
			break;

...
class ScheduledEvent implements Comparable,Nodeable{
	...
	public long getTime(){return m_time.longValue();}
	public Asset getAsset(){return m_asset;}
	public ScriptTemplate_Abstract getListener(){return m_listener;}
...
public class Scheduler implements ActionListener,ScriptConvertible,Nodeable{
	...
	public long getCurrentGameTime(){return m_gameTime;}
	...
	public void setDefaultListener(ScriptTemplate_Abstract defaulter){m_defaultListener=defaulter;}
	public ScriptTemplate_Abstract getDefaultListener(){return m_defaultListener;}
	public void actionPerformed(ActionEvent e){
		long differential=(long)(((double)(getCurrentTime()-m_lastIteration))*m_compression);
		m_lastIteration=getCurrentTime();

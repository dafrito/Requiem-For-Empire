...
public class RiffToolbox{
	...
	public static boolean areEqual(Point.System point, double a, double b){
		switch(point){
		case SPHERICAL:
			if((areEqual(Point.System.EUCLIDEAN, a, 180.0d)||areEqual(Point.System.EUCLIDEAN, a,0.0d))&&(areEqual(Point.System.EUCLIDEAN,b,180.0d)||areEqual(Point.System.EUCLIDEAN,b,0.0d))){return true;}
